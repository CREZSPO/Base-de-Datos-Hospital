...
ADD CONSTRAINT pk_especialista_especialidad PRIMARY KEY (id_especialista_especialidad),
ADD FOREIGN KEY (id_especialidad) REFERENCES especialidad(id_especialidad),
ADD FOREIGN KEY (id_especialista) REFERENCES especialista(id_especialista);

ALTER TABLE especialista_especialidad
ALTER COLUMN id_especialista SET NOT NULL,
